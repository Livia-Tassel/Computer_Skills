...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN
    ps, os = player_score % 10, (opponent_score // 10) % 10
    return max(1, 3 * abs(ps - os))
    # END
...
# the real time strategy need combine both your score and your opponent score to reach the best method, while the always_roll strategy kind of simple so that even ignore the information.
def always_roll(n):
...
def make_averaged(original_function, samples_count=1000):
    ...
    def function(*args):
        ans = 0
        for k in range(0, samples_count):
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN
    bscore = boar_brawl(score, opponent_score)
    if bscore >= threshold:
        return 0
    else:
        return num_rolls
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN
    sscore = sus_update(0, score, opponent_score) - score
    if sscore >= threshold:
        return 0
    else:
        return num_rolls
...
def final_strategy(score, opponent_score):
    ...
    if sscore >= exp_roll_six:
        ...
        if (score - opponent_score) >= -7:
            ...
            return 7
        elif (score - opponent_score) >= -18:
            return 8
        elif (score - opponent_score) >= -24:
            return 9
        else:
            return 10
    # END
